...
the end date was Mrch 15, 2016.

Write a query to print total number of unique hackers who made at least 1 submission each day (starting
on the first day of the contest), and find the hacker_id and name of the hacker who made maximum number of 
...
Input Format
The following tables should hold contest data:
*Hackers: The hacker_id is the id of the hacker, and name is the name of the hacker. 


*Submissions: The submission_data is the date of the submission, submission_id is the id of the submission, 
